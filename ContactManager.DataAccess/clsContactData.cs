...
namespace ContactManager.DataAccess
{
    ...
    {
        private static string Connectionstring = "Server=your server name; Database=contactdb1; User Id=your name; Password=your password; TrustServerCertificate=True;";
